        ...
        <AnimatePresence>
          {nftPacks.map((pack) => {
            ...
            return (
              ...
              >
                <Card
                  className={`bg-gray-800 overflow-hidden h-full flex flex-col rounded-lg shadow-md ${
                ...
                >
                  ...
                  <CardContent className="p-2 flex-grow">
                    <CardTitle className="text-sm font-semibold mb-1 text-white truncate">
                      {pack.title}
                    </CardTitle>
                    <Badge
                      variant="secondary"
                      className="mb-1 text-xs px-1 py-0"
                    >
                      {pack.price} Tokens
                    </Badge>
                    <p
